										...
										>
											...
											>
												...
												<motion.button
													...
													type='submit'
													className='w-full bg-gradient-to-r from-chat-pink to-chat-purple text-white font-semibold py-3 px-6 rounded-xl hover:shadow-lg hover:shadow-chat-pink/30 transition-all duration-300 flex items-center justify-center gap-2 group'
													whileHover={{
														scale: 1.02,
													}}
													whileTap={{
